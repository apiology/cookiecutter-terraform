...
Report bugs at https://github.com/apiology/cookiecutter-terraform/issues
...
Cookiecutter Terraform could always use more documentation, whether as part of
the official Cookiecutter Terraform docs, in docstrings, or even on the web in blog posts, articles,
and such.
...
https://github.com/apiology/cookiecutter-terraform/issues.
...
Ready to contribute? Here's how to set up `cookiecutter-terraform` for local
development. Please note this documentation assumes you already have
`virtualenv` and `Git` installed and ready to go.

1. Fork the `cookiecutter-terraform` repo on GitHub.
...
2. Clone your fork locally:
   ...
   .. code-block:: bash
    ...
    $ git clone git@github.com:YOUR_NAME/cookiecutter-terraform.git
...
3. You can create a new environment for your local development by typing:
   ...
   .. code-block:: bash
        ...
        $ virtualenv cookiecutter-terraform-env
        $ source cookiecutter-terraform-env/bin/activate

   This should change the shell to look something like:

   .. code-block:: bash

        (cookiecutter-terraform-env) $
...
6. The next step would be to run the test cases. `cookiecutter-terraform` uses
...
3. The pull request should work for Python 3.7, 3.8, 3.9 and 3.10. Check
   https://app.circleci.com/pipelines/github/apiology/cookiecutter-terraform and
...
.. cookiecutter: https://github.com/apiology/cookiecutter-terraform
